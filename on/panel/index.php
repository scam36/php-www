...
$content = "
	<div class=\"panel\">
		<div class=\"top\">
			<div class=\"left\">
				<img style=\"width: 60px; height: 60px; float: left; margin: 5px 10px 0px 0px; display: block;\" src=\"".(file_exists("{$GLOBALS['CONFIG']['SITE']}/images/users/{$userinfo['id']}.png")?"/{$GLOBALS['CONFIG']['SITE']}/images/users/{$userinfo['user_id']}.png":"/{$GLOBALS['CONFIG']['SITE']}/images/users/user.png")."\" />
