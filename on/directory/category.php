...
$connectors = api::send('busit/connector/list', array('category'=>$_GET['id'], 'start'=>0, 'limit'=>250), $GLOBALS['CONFIG']['API_USERNAME'].':'.$GLOBALS['CONFIG']['API_PASSWORD']);

$category = api::send('busit/category/list', array('id'=>$_GET['id']), $GLOBALS['CONFIG']['API_USERNAME'].':'.$GLOBALS['CONFIG']['API_PASSWORD']);
$category = $category[0];

$content = "
		<div class=\"store\">
			<div class=\"container\">
				<h1 class=\"dark\">".$lang[$category['category_name']]."</h1>
				<br />
";
